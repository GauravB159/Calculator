...
public class linearvar4 extends AppCompatActivity {
    static String [][] str;
    static String[] str2;
    static EditText[][] arr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linearvar4);
        del=(Button)findViewById(R.id.clear);
        arr=new EditText[4][4];
        arr2=new EditText[4];
        str=new String[4][4];
        str2=new String[4];
        arr[0][0]=(EditText)findViewById(R.id.ip1);
        arr[0][1]=(EditText)findViewById(R.id.ip2);
        arr[0][2]=(EditText)findViewById(R.id.ip3);
        arr[0][3]=(EditText)findViewById(R.id.ip4);
        arr[0][0].setHorizontallyScrolling(true);

        arr[1][0]=(EditText)findViewById(R.id.ip6);
        arr[1][1]=(EditText)findViewById(R.id.ip7);
        arr[1][2]=(EditText)findViewById(R.id.ip8);
        arr[1][3]=(EditText)findViewById(R.id.ip9);


        arr[2][0]=(EditText)findViewById(R.id.ip11);
        arr[2][1]=(EditText)findViewById(R.id.ip12);
        arr[2][2]=(EditText)findViewById(R.id.ip13);
        arr[2][3]=(EditText)findViewById(R.id.ip14);

        arr[3][0]=(EditText)findViewById(R.id.ip16);
        arr[3][1]=(EditText)findViewById(R.id.ip17);
        arr[3][2]=(EditText)findViewById(R.id.ip18);
        arr[3][3]=(EditText)findViewById(R.id.ip19);

        arr2[0]=(EditText)findViewById(R.id.ip5);
        arr2[1]=(EditText)findViewById(R.id.ip10);
        arr2[2]=(EditText)findViewById(R.id.ip15);
        arr2[3]=(EditText)findViewById(R.id.ip20);
