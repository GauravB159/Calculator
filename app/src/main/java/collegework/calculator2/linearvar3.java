...
public class linearvar3 extends AppCompatActivity {
    static String [][] str;
    static String[] str2;
    static EditText[][] arr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linearvar3);
        del=(Button)findViewById(R.id.clear);
        arr=new EditText[3][3];
        arr2=new EditText[3];
        str=new String[3][3];
        str2=new String[3];
        ...
        arr[1][0]=(EditText)findViewById(R.id.ip5);
        arr[1][1]=(EditText)findViewById(R.id.ip6);
        arr[1][2]=(EditText)findViewById(R.id.ip7);

        arr[2][0]=(EditText)findViewById(R.id.ip9);
        arr[2][1]=(EditText)findViewById(R.id.ip10);
        arr[2][2]=(EditText)findViewById(R.id.ip11);

        arr2[0]=(EditText)findViewById(R.id.ip4);
        arr2[1]=(EditText)findViewById(R.id.ip8);
        arr2[2]=(EditText)findViewById(R.id.ip12);
